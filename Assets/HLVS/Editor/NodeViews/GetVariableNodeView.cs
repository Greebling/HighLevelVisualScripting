...
namespace HLVS.Editor.NodeViews
{
	...
	public class GetVariableNodeView : HlvsNodeView
	{
		private GetVariableNode _target;
		...
		public override void Enable()
		{
			...
			_target = (GetVariableNode)nodeTarget;
		...
		private DropdownField CreateDropDown()
		{
			...
			{
				owner.RegisterCompleteObjectUndo("Updated variable name of GetVariableNode");
				_target.variableName = v.newValue;

				title = "Get '" + _target.variableName + "'";
				ForceUpdatePorts();
